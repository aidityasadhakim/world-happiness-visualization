...
def africanComparisonVisualization(df):
    background = "#fbfbfb"
    low_c = '#dd4124'
    high_c = '#009473'
    ...
    sns.scatterplot(data=df, x='Healthy life expectancy', y='Ladder score',hue=df['Country'] == 'Indonesia',palette=cmap, alpha=0.9,ec='black',size=df["Logged GDP per capita"]*1000, legend=True, sizes=(5, 500))
